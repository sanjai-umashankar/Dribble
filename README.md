...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand" href="#" title="Dribbble: the community for graphic design">
        <svg xmlns="http://www.w3.org/2000/svg" width="210" height="25" viewBox="0 0 210 59" fill="none">
  ...
  <section class="py-5">
    <div class="container">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
        ...
        <div class="col">
          <div class="card">
            <img src="b1.jpeg" class="card-img-top" alt="Design">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <img src="b2.jpeg" class="card-img-top" alt="Design">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <img src="b3.jpeg" class="card-img-top" alt="Design">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <img src="b4.jpeg" class="card-img-top" alt="Design">
            <div class="card-body">
        ...
        <div class="row-cols-1">
            <div class="card">
              <img src="b5.jpeg" class="card-img-top" alt="Design">
              <div class="card-body">
                <p class="card-text">Jan Losert</p>
              </div>
            </div>
          ...
          <div class="row-cols-1">
            <div class="card">
              <img src="b6.jpeg" class="card-img-top" alt="Design">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
              <img src="b7.jpeg" class="card-img-top" alt="Design">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
              <img src="b8.jpeg" class="card-img-top" alt="Design">
              <div class="card-body">
  ...
  <footer id="footer">
    <h2 style="background-color: dimgray; text-align: center;font-size: 18px;">Designed and developed by SANJAI U</h2>
</footer>
